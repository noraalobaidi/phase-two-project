...
<a href="GetClassServlet" style="font-size:15px">Classes List</a>
<p style="font-size:15px;margin-left:10px;margin-right:10px">  >  </p>
<p style="font-size:15px">Insert Class</p>

</div>
<form action="InsertClassServlet">
<h5 style="margin:0;"><label >Room Name</label></h5>
<input type="text" placeholder="ex. 11/3" name="roomName"style="margin-bottom:10px;font-size:17px;height:30px;border-radius: 5px;border-width:1px;border-color:#cccccc;width:350px">
